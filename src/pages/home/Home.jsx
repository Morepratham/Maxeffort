  ...
  return (
    <section className="flex h-[calc(100vh-6px)] flex-col items-center justify-center">
      ...
      <div
        ...
        className="absolute right-5 top-5 flex cursor-pointer items-center gap-1 rounded-xl bg-white px-4 py-2 shadow-md transition-all duration-300 hover:bg-blue-100 active:bg-slate-500"
      >
        {LogoutSvg}
